...
"}"));
        key_frame = new QFrame(login_dialog);
        key_frame->setObjectName(QStringLiteral("key_frame"));
        key_frame->setGeometry(QRect(50, 360, 691, 181));
...
"}"));
        ...
        horizontalLayoutWidget->setGeometry(QRect(160, 240, 471, 21));
        horizontalLayout = new QHBoxLayout(horizontalLayoutWidget);
        horizontalLayout->setObjectName(QStringLiteral("horizontalLayout"));
        horizontalLayout->setContentsMargins(0, 0, 0, 0);
        label = new QLabel(login_dialog);
        label->setObjectName(QStringLiteral("label"));
        label->setGeometry(QRect(0, 2, 759, 27));
        QFont font;
        font.setPointSize(16);
        label->setFont(font);
        label->setStyleSheet(QLatin1String("#label { \n"
"background-color: transparent;\n"
"background-image: url(:/barras/screen800x600/barras/barra superior contrasena.png);\n"
"border: none; \n"
"background-repeat: none;\n"
" } "));
        label->setAlignment(Qt::AlignCenter);
        asa_logo = new QPushButton(login_dialog);
...
"} "));
        ...
        label_2->setGeometry(QRect(259, -1, 261, 30));
    ...
    void retranslateUi(QDialog *login_dialog)
    {
        ...
        label_2->setText(QApplication::translate("login_dialog", "Contrase\303\261a", Q_NULLPTR));
    } // retranslateUi
