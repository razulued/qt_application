/********************************************************************************
** Form generated from reading UI file 'change_text.ui'
**
...
#ifndef UI_CHANGE_TEXT_H
#define UI_CHANGE_TEXT_H
...
public:
    ...
    void setupUi(QDialog *change_text)
    {
        if (change_text->objectName().isEmpty())
            change_text->setObjectName(QStringLiteral("change_text"));
        change_text->resize(800, 600);
        asa_logo = new QPushButton(change_text);
        asa_logo->setObjectName(QStringLiteral("asa_logo"));
        asa_logo->setGeometry(QRect(740, 540, 51, 51));
...
"} "));
        ...
        key_frame = new QFrame(change_text);
        key_frame->setObjectName(QStringLiteral("key_frame"));
        key_frame->setGeometry(QRect(50, 350, 691, 181));
...
"}"));
        ...
        textEdit = new QTextEdit(change_text);
        textEdit->setObjectName(QStringLiteral("textEdit"));
        textEdit->setGeometry(QRect(80, 120, 641, 70));

        retranslateUi(change_text);

        QMetaObject::connectSlotsByName(change_text);
    } // setupUi

    void retranslateUi(QDialog *change_text)
    {
        change_text->setWindowTitle(QApplication::translate("change_text", "Dialog", Q_NULLPTR));
...
namespace Ui {
    class change_text: public Ui_change_text {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_CHANGE_TEXT_H
