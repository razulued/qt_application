...
QT_MOC_LITERAL(1, 19, 13), // "update_window"
QT_MOC_LITERAL(2, 33, 0) // ""

    },
    "mod_3_clarificador\0update_window\0"
};
...
void mod_3_clarificador::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        mod_3_clarificador *_t = static_cast<mod_3_clarificador *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (mod_3_clarificador::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&mod_3_clarificador::update_window)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void mod_3_clarificador::update_window()
{
