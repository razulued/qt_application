...
"}"));
        ...
        horizontalLayoutWidget->setGeometry(QRect(50, 130, 691, 21));
        horizontalLayout = new QHBoxLayout(horizontalLayoutWidget);
        horizontalLayout->setObjectName(QStringLiteral("horizontalLayout"));
        horizontalLayout->setContentsMargins(0, 0, 0, 0);
        label = new QLabel(login_dialog);
        label->setObjectName(QStringLiteral("label"));
        label->setGeometry(QRect(270, 0, 221, 31));
        QFont font;
...
"} "));
    ...
    void retranslateUi(QDialog *login_dialog)
    {
        ...
        label->setText(QApplication::translate("login_dialog", "Contrase\303\261a", 0));
