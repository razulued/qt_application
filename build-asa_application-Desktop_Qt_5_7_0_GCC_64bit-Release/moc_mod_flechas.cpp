...
QT_MOC_LITERAL(1, 12, 13), // "update_window"
QT_MOC_LITERAL(2, 26, 0) // ""

    },
    "mod_flechas\0update_window\0"
};
...
void mod_flechas::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        mod_flechas *_t = static_cast<mod_flechas *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (mod_flechas::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&mod_flechas::update_window)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void mod_flechas::update_window()
{
