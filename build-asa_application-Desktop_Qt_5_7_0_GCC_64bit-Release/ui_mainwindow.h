...
"} "));
        ...
        widget->setGeometry(QRect(80, 490, 81, 61));
        widget_2 = new QWidget(centralWidget);
        widget_2->setObjectName(QStringLiteral("widget_2"));
        widget_2->setGeometry(QRect(40, 210, 81, 61));
        widget_2->setStyleSheet(QStringLiteral(""));
        widget_3 = new QWidget(centralWidget);
        widget_3->setObjectName(QStringLiteral("widget_3"));
        widget_3->setGeometry(QRect(160, 260, 81, 61));
        ...
        widget_8->setGeometry(QRect(620, 140, 81, 61));
        ...
        widget_10->setGeometry(QRect(730, 130, 81, 61));
