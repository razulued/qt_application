...
QT_MOC_LITERAL(2, 29, 0) // ""
    ...
    "mod_5_digestor\0update_window\0"
};
...
void mod_5_digestor::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        mod_5_digestor *_t = static_cast<mod_5_digestor *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (mod_5_digestor::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&mod_5_digestor::update_window)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void mod_5_digestor::update_window()
{
