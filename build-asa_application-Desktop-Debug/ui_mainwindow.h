...
" } "));
        ...
        pb_fisicos->setGeometry(QRect(597, 726, 33, 26));
        pb_fisicos->setFocusPolicy(Qt::NoFocus);
        pb_fisicos->setStyleSheet(QLatin1String("#pb_fisicos { \n"
"background-color: transparent;\n"
"border-image: url(:/iconos/images/Iconos/Medidor_azul.png);\n"
"background: none; \n"
"border: none; \n"
"background-repeat: none;\n"
" } "));
        ...
        pb_quimicos->setGeometry(QRect(720, 723, 24, 28));
        pb_quimicos->setFocusPolicy(Qt::NoFocus);
        pb_quimicos->setStyleSheet(QLatin1String("#pb_quimicos { \n"
"background-color: transparent;\n"
"border-image: url(:/iconos/images/Iconos/Matraz_azul.png);\n"
" background: none; \n"
"border: none; \n"
"background-repeat: none;\n"
" } \n"
""));
        ...
        pb_electricos->setGeometry(QRect(839, 723, 28, 28));
        pb_electricos->setFocusPolicy(Qt::NoFocus);
        pb_electricos->setStyleSheet(QLatin1String("#pb_electricos { \n"
"background-color: transparent;\n"
"border-image: url(:/iconos/images/Iconos/Clavija_azul.png);\n"
"background: none; \n"
"border: none; \n"
"background-repeat: none;\n"
" } "));
...
"background-repeat: none;\n"
" } "));
        asa_logo = new QLabel(centralWidget);
        asa_logo->setObjectName(QStringLiteral("asa_logo"));
        asa_logo->setGeometry(QRect(970, 710, 31, 48));
        asa_logo->setStyleSheet(QLatin1String("#asa_logo{ \n"
"background-color: transparent;\n"
"border-image: url(:/iconos/images/Iconos/ASA_logo.png); \n"
"background: none; \n"
"border: none; \n"
"background-repeat: none;\n"
" } "));
