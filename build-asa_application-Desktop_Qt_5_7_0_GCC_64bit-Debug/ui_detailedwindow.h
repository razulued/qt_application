...
"}"));
        ...
        button_parametros->setGeometry(QRect(20, 200, 31, 50));
...
"}"));
        ...
        button_evento->setGeometry(QRect(59, 200, 31, 50));
...
"}"));
        ...
        button_candado = new QPushButton(tab_5);
        button_candado->setObjectName(QStringLiteral("button_candado"));
        button_candado->setGeometry(QRect(269, 2, 31, 31));
        button_candado->setFocusPolicy(Qt::NoFocus);
        button_candado->setStyleSheet(QLatin1String("#button_candado{\n"
"border-image: url(:/iconos/screen800x600/iconos/locked.png);\n"
"background-repeat: none;\n"
"background-position: center;\n"
"}"));
        button_candado->setCheckable(false);
...
"}"));
        ...
        key_OK->setGeometry(QRect(190, 166, 81, 31));
...
"}"));
        ...
        key_Reschedule->setGeometry(QRect(20, 166, 91, 31));
...
"}"));
        ...
        label_horas->setGeometry(QRect(31, 172, 47, 18));
...
"}"));
        ...
        button_visualizacion->setGeometry(QRect(134, 200, 31, 50));
...
""));
        ...
        button_control->setGeometry(QRect(168, 200, 31, 50));
...
"}"));
        ...
        imagen->setGeometry(QRect(30, 40, 181, 161));
...
" } "));
        ...
        button_descripcion->setGeometry(QRect(97, 200, 31, 50));
...
"}"));
    ...
    void retranslateUi(QDialog *detailedwindow)
    {
        ...
        button_candado->setText(QString());
